...
## Individual Wells
Create ternary plots of Quartz.Feldspar vs Carbonate vs TotalClay content of successful Duvernay wells in the asset area
```{r IndividualWells}
...
## All wells
Create a single ternary plot of successful Duvernay wells in the area along with the new well in order to directly compare Duvernay mineralogy.
